...
int gpio_periph_mux_set(PioPeriphMux mux, uint8_t pioChannel, bool periphPullUpDownOn)
{
    ...
    switch (mux) {
      ...
      case PIO_MUX_PERIPH_1:
    	  pio_channel_regbase->pio_pdr_0 = (1 << channel_offset_in_reg);     // pio disable
    	  pio_channel_regbase->pio_bsr_0 |= (1 << channel_offset_in_reg);    // mux1 enable
    	  break;

      case PIO_MUX_PERIPH_2:
    	  pio_channel_regbase->pio_pdr_0 = (1 << channel_offset_in_reg);     // pio disable
    	  pio_channel_regbase->pio_csr_0 |= (1 << channel_offset_in_reg);    // mux2 enable
    	  break;

      case PIO_MUX_PERIPH_3:
    	  pio_channel_regbase->pio_pdr_0 = (1 << channel_offset_in_reg);     // pio disable
    	  pio_channel_regbase->pio_dsr_0 |= (1 << channel_offset_in_reg);    // mux3 enable
    	  break;
